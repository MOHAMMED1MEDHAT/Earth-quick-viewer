...
public class EarthquakeCityMap extends PApplet {
	...
	private void printQuakes() 
	{
		...
		int countOfQuakes=quakeMarkers.size();
		int countOfOceanQuakes=0;
		for(Marker countryMarker:countryMarkers) {
			...
			for(Marker m:quakeMarkers) {
				...
				if(name.equals(country)) {
					countOfOceanQuakes++;
					System.out.println(name+" and "+country);
				}
			}
		}
		System.out.println(countOfQuakes+" "+countOfOceanQuakes);
