...
//			System.out.println("hallow from x");
	...
	private void colorDetermine(PGraphics pg) {
		...
		if(0<=this.getDepth()&&this.getDepth()<70) {
			pg.fill(239 ,234 ,18);
		}else if(70<=this.getDepth()&&this.getDepth()<300) {
			pg.fill(18, 50 ,239);
		}else if(300<=this.getDepth()&&this.getDepth()<700) {
			pg.fill(255,0,0);
		}
	}
